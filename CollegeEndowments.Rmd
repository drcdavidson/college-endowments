...
The data for this analysis came from IPEDS. The code to build the college data set was written to merge 18 separate data files to create the College Graduation Data set that included 10-years of data to account for any anomalies in the data. The 19th file provides the definitions of the variables in the data set. Once the files were merged, there were 44,622 observations. Any cases that had at least one null value for any variable were removed from the data set. The final number of observations in the data set was 27,732. Table 1 provides the definitions of the variables in the data. Table 2 

```{r Create Tables showing Variables, echo=FALSE, message=FALSE, warning=FALSE}
## Install Libraries ##
...
```{r Create Table for Categorical Variables, echo=FALSE, message=FALSE}
...
```{r Create Table for Continuous Variables, echo=FALSE, message=FALSE}
################
